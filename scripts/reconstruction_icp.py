...
def main():
    ...
    source = o3d.io.read_point_cloud(pcd_dir + "pcd0.pcd")
    ...
    for i in range(1, count):
        target = o3d.io.read_point_cloud(pcd_dir + f'pcd{i}.pcd')
        ...
        result_icp = o3d.pipelines.registration.registration_icp(
            source, target, max_correspondence_distance, current_transformation,
