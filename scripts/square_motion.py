...
for j in range(h):
    for i in range(1, 5):
        ...
        prev_pose.orientation.x = quaternion[0]
        prev_pose.orientation.y = quaternion[1]
        prev_pose.orientation.z = quaternion[2]
        prev_pose.orientation.w = quaternion[3]

        waypoints = []
        waypoints.append(prev_pose)
